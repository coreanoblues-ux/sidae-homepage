...
export default function ProgramPage() {
  ...
  const programDescs: Record<string, string> = {
    "middle-school": "우리가 가르치는 것은 단지 한 페이지가 아닙니다. 아이가 살아갈 더 나은 내일입니다. 시대영재 × 페이지원 영어학원 중등 영어 과정 — 탄탄한 문법·독해 기초부터 내신 완벽 대비까지. 광주 남구 봉선동.",
    "high-school":   "우리가 가르치는 것은 단지 한 페이지가 아닙니다. 아이가 살아갈 더 나은 내일입니다. 시대영재 × 페이지원 영어학원 고등 수능 영어 과정 — 서술형·SYNTAX 구문독해·수능 1등급 대비. 광주 남구 봉선동.",
  };
  useSEO({
    title: programTitles[slug ?? ""] ?? "봉선동 영어학원 시대영재 × 페이지원 영어학원 — 프로그램 안내",
    description: programDescs[slug ?? ""] ?? "우리가 가르치는 것은 단지 한 페이지가 아닙니다. 아이가 살아갈 더 나은 내일입니다. 시대영재 × 페이지원 영어학원 프로그램 안내 — 광주 남구 봉선동 중고등 영어 전문.",
