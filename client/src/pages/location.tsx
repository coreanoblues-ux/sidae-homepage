...
export default function Location() {
  ...
  useSEO({
    ...
    description:
      "오늘의 한 페이지가, 내일의 등급을 결정합니다. 시대영재 × 페이지원 영어학원 오시는 길 — 광주광역시 남구 봉선중앙로 16, 2층. 봉선중·봉선고 근방, 봉선동 아파트 단지에서 도보 가능. 전화 062-462-0990.",
    keywords:
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="hero-gradient text-white py-16 lg:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p
            className="text-lg md:text-xl text-orange-100 mb-4 leading-snug"
