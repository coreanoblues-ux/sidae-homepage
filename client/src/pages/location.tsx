...
export default function Location() {
  ...
  useSEO({
    ...
    description:
      "우리가 가르치는 것은 단지 한 페이지가 아닙니다. 아이가 살아갈 더 나은 내일입니다. 시대영재 × 페이지원 영어학원 오시는 길 — 광주광역시 남구 봉선중앙로 16, 2층. 봉선중·봉선고 근방, 봉선동 아파트 단지에서 도보 가능. 전화 062-462-0990.",
    keywords:
      ...
      <section className="hero-gradient text-white py-16 lg:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="tagline-serif text-base md:text-lg text-orange-100 mb-4 leading-relaxed">
            우리가 가르치는 것은 단지 한 페이지가 아닙니다. <span className="tagline-serif-emph text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B00] to-orange-300">아이가 살아갈 더 나은 내일</span>입니다.
          </p>
